...
public class JKProcessLifecycleOwner : NSObject, JKLifecycleOwner {
    ...
    public static func setup() {
        ...
        NotificationCenter.default.addObserver(instance, selector: #selector(applicationBecomeActive(_ :)), name: NSNotification.Name.UIApplicationDidBecomeActive, object: nil)
        NotificationCenter.default.addObserver(instance, selector: #selector(applicationDidEnterBackground(_ :)), name: NSNotification.Name.UIApplicationDidEnterBackground, object: nil)
        NotificationCenter.default.addObserver(instance, selector: #selector(applicationWillTerminate(_ :)), name: NSNotification.Name.UIApplicationWillTerminate, object: nil)
